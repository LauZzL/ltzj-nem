...
var _0x1e2f79: {
  ...
  e: function _0xe3f2e6(_0x586254: string): string {
    try {
      const _0x547d76: number = _0x1cd24c[a0_0x10cc[12251]](-0x10);
      const _0x4fa523: number = _0x1269d7(
        _0x586254,
        _0x1cd24c[a0_0x10cc[12252]]
      );
      const _0x3a3eca: number = _0x18f822;
      _0x1cd24c["e"](_0x547d76, _0x4fa523, _0x3a3eca);
      const _0x54f338: number = _0x25184d()["getInt32"](_0x547d76 + 0x0, true);
      const _0x393745: number = _0x25184d()["getInt32"](_0x547d76 + 0x4, true);
      //@ts-ignore
      const _0x28ad81: string = _0x519b70(_0x54f338, _0x393745).toString();
      _0x1cd24c["__wbindgen_free"](_0x54f338, 0x1 * _0x393745, 0x1);
      return _0x28ad81;
    } finally {
      _0x1cd24c[a0_0x10cc[12251]](0x10);
    }
...
const ltzj = {
  ...
  encrypt: function (e: any): ArrayBuffer | string {
    ...
    try {
      ...
      _0x1a1819 = JSON.stringify(that["data"]);
      // @ts-ignore
      _0x48ba5a = TextEncoderDecoder.encodeText(_0x1a1819).buffer;
      //@ts-ignore
